...
class TestTitleFeatures:
    def test_title_length_exact_values(self):
        from hn_simulator.features.structural import extract_title_features
...
class TestTemporalFeatures:
    def test_hour_of_day_exact(self):
        from hn_simulator.features.structural import extract_temporal_features
        df = pd.DataFrame({
...
class TestUrlFeatures:
    def test_has_url(self):
        from hn_simulator.features.structural import extract_url_features
        df = pd.DataFrame({
...
class TestTextFeatures:
    def test_has_text_and_length_exact(self):
        from hn_simulator.features.structural import extract_text_presence_features
