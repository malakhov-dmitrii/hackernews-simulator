...
class TestStripHtml:
    def test_strips_p_tags(self):
        from hackernews_simulator.data.preprocess import strip_html
...
class TestExtractDomain:
    def test_extracts_github(self):
        from hackernews_simulator.data.preprocess import extract_domain
...
class TestClassifyPostType:
    def test_show_hn(self):
        from hackernews_simulator.data.preprocess import classify_post_type
