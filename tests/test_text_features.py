...
class TestEmbeddingModelLoadFailure:
    ...
    def test_raises_on_model_load_failure(self):
        ...
        with patch("hn_simulator.features.text.SentenceTransformer", side_effect=OSError("Model not found")):
...
class TestSaveLoadEmbeddings:
    def test_save_and_load_roundtrip(self, tmp_path):
        from hn_simulator.features.text import save_embeddings, load_embeddings
    ...
    def test_load_nonexistent_raises(self, tmp_path):
        from hn_simulator.features.text import load_embeddings
