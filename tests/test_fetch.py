...
class TestQueryConstruction:
    def test_stories_query_selects_correct_columns(self):
        from hackernews_simulator.data.fetch import build_stories_query
    ...
    def test_comments_query_uses_correct_columns(self):
        from hackernews_simulator.data.fetch import build_comments_query
    ...
    def test_stratified_sampling_query(self):
        from hackernews_simulator.data.fetch import build_stratified_stories_query
...
class TestDuckDBConnectionFailure:
    ...
    def test_fetch_raises_on_connection_error(self):
        from hackernews_simulator.data.fetch import fetch_stories
        with patch("hackernews_simulator.data.fetch.duckdb") as mock_duckdb:
